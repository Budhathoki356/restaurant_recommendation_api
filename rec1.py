...
zomato_dataset = zomato_dataset.sample(n = 9000)
...
zomato_dataset['reviews_list'].replace('',np.nan)
...
zomato_dataset['reviews_list'].isna().sum()
...
# with open('recommended1.pkl','wb') as file:
#     pickle.dump(calc,file)
        

# calc(800,'pizza','jayanagar')
# =============================================================================
# 
# 
...
#   
# # Encode labels in columns with categorical values
# zomato_dataset['name']= label_encoder.fit_transform(zomato_dataset['name'])
# zomato_dataset['location']= label_encoder.fit_transform(zomato_dataset['location'])
# zomato_dataset['reviews_list']= label_encoder.fit_transform(zomato_dataset['reviews_list'])
# zomato_dataset['cuisines']= label_encoder.fit_transform(zomato_dataset['cuisines'])
# 
# # feature set containing every column except the rate column i.e target column
# x = zomato_dataset.drop('rate',axis = 1)
# 
# # Target column is rate
# y = pd.to_numeric(zomato_dataset['rate'])
# 
# # Label the rate
# label=zomato_dataset['rate'].values
# 
# # Converting the feature set into the standrard scale
...
# =============================================================================
# 
# reviews = pd.DataFrame(zomato_dataset['reviews_list'])
# 
...
# y = zomato_dataset.iloc[:, 1].values
# 
# 
